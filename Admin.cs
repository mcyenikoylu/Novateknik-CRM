...
namespace deneme
{
	...
	public class Admin : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Admin));
			...
			this.panel2.Location = new System.Drawing.Point(216, 144);
			...
			this.Closed += new System.EventHandler(this.Admin_Closed);
		...
		{
			MessageBox.Show(this,"Zaten Admin Yeni Ýþlemler Sayfasýndasýnýz.","HATA Yaptýnýz");
		}
		...
		private void btnKayit_Click(object sender, System.EventArgs e)
		{
			...
			{
				ekle["Yetki"]=yetki;
				ekle["Name"]=txtKullanici.Text.Trim();
				ekle["Password"]=txtSifre.Text.Trim();

				ds_users1.Tables["tbl_users"].Rows.Add(ekle);
				sqlDataAdapter1.Update(ds_users1,"tbl_users");
		...
		private void Admin_Closed(object sender, System.EventArgs e)
		{
			Application.Exit();
		}
