...
namespace deneme
{
	...
	/// </summary>
	public class KartlarYeni : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(KartlarYeni));
			...
			this.gbFirma.Location = new System.Drawing.Point(176, 152);
			...
			// cbSehir
			// 
			this.cbSehir.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.ds_musteri1, "tbl_mk.Sehir"));
			...
			// txtSemt
			// 
			this.txtSemt.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.ds_musteri1, "tbl_mk.Semt"));
			...
			// txtFMail
			// 
			this.txtFMail.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.ds_musteri1, "tbl_mk.FirmaMail"));
			...
			// txtWeb
			// 
			this.txtWeb.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.ds_musteri1, "tbl_mk.Web"));
			...
			// txtVerNo
			// 
			this.txtVerNo.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.ds_musteri1, "tbl_mk.VergiNo"));
			...
			// txtVerDai
			// 
			this.txtVerDai.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.ds_musteri1, "tbl_mk.Vergi"));
			...
			// txtAdres
			// 
			this.txtAdres.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.ds_musteri1, "tbl_mk.Adres"));
			...
			// txtFax
			// 
			this.txtFax.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.ds_musteri1, "tbl_mk.Fax"));
			...
			// txtTel2
			// 
			this.txtTel2.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.ds_musteri1, "tbl_mk.Tel2"));
			...
			// txtTel1
			// 
			this.txtTel1.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.ds_musteri1, "tbl_mk.Tel1"));
			...
			// txtFIsim
			// 
			this.txtFIsim.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.ds_musteri1, "tbl_mk.Isim"));
			...
			this.gbKisi.Location = new System.Drawing.Point(592, 288);
			...
			// txtDep
			// 
			this.txtDep.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.ds_musteri1, "tbl_mk.Departman"));
			...
			// txtKMail
			// 
			this.txtKMail.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.ds_musteri1, "tbl_mk.KisiMail"));
			...
			// txtCepTel
			// 
			this.txtCepTel.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.ds_musteri1, "tbl_mk.CepTel"));
			...
			// txtDahili
			// 
			this.txtDahili.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.ds_musteri1, "tbl_mk.Dahili"));
			...
			// txtUnvan
			// 
			this.txtUnvan.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.ds_musteri1, "tbl_mk.Unvan"));
			...
			// txtSoyad
			// 
			this.txtSoyad.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.ds_musteri1, "tbl_mk.Soyad"));
			...
			// txtAd
			// 
			this.txtAd.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.ds_musteri1, "tbl_mk.Ad"));
			...
			this.gbAlan.Location = new System.Drawing.Point(592, 152);
			...
			// cbLevel
			// 
			this.cbLevel.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.ds_musteri1, "tbl_mk.Lvel"));
			...
			// cbSektor
			// 
			this.cbSektor.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.ds_musteri1, "tbl_mk.Sektor"));
			...
			// btnKaydet
			// 
			this.btnKaydet.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(162)));
			this.btnKaydet.ForeColor = System.Drawing.SystemColors.ControlDarkDark;
			this.btnKaydet.Location = new System.Drawing.Point(904, 576);
			...
			// sqlInsertCommand1
			// 
			this.sqlInsertCommand1.CommandText = @"INSERT INTO tbl_mk(Isim, Tel1, Tel2, Fax, Semt, Adres, Sehir, Vergi, VergiNo, Web, FirmaMail, Sektor, Departman, Lvel, Ad, Soyad, Unvan, Dahili, CepTel, KisiMail, Sil, Tarih, Saat) VALUES (@Isim, @Tel1, @Tel2, @Fax, @Semt, @Adres, @Sehir, @Vergi, @VergiNo, @Web, @FirmaMail, @Sektor, @Departman, @Lvel, @Ad, @Soyad, @Unvan, @Dahili, @CepTel, @KisiMail, @Sil, @Tarih, @Saat); SELECT KartID, Isim, Tel1, Tel2, Fax, Semt, Adres, Sehir, Vergi, VergiNo, Web, FirmaMail, Sektor, Departman, Lvel, Ad, Soyad, Unvan, Dahili, CepTel, KisiMail, Sil, Tarih, Saat FROM tbl_mk WHERE (KartID = @@IDENTITY)";
			...
			// sqlSelectCommand1
			// 
			this.sqlSelectCommand1.CommandText = "SELECT KartID, Isim, Tel1, Tel2, Fax, Semt, Adres, Sehir, Vergi, VergiNo, Web, Fi" +
				"rmaMail, Sektor, Departman, Lvel, Ad, Soyad, Unvan, Dahili, CepTel, KisiMail, Si" +
				"l, Tarih, Saat FROM tbl_mk";
			this.sqlSelectCommand1.Connection = this.sqlConnection1;
			// 
			// sqlUpdateCommand1
			// 
			this.sqlUpdateCommand1.CommandText = @"UPDATE tbl_mk SET Isim = @Isim, Tel1 = @Tel1, Tel2 = @Tel2, Fax = @Fax, Semt = @Semt, Adres = @Adres, Sehir = @Sehir, Vergi = @Vergi, VergiNo = @VergiNo, Web = @Web, FirmaMail = @FirmaMail, Sektor = @Sektor, Departman = @Departman, Lvel = @Lvel, Ad = @Ad, Soyad = @Soyad, Unvan = @Unvan, Dahili = @Dahili, CepTel = @CepTel, KisiMail = @KisiMail, Sil = @Sil, Tarih = @Tarih, Saat = @Saat WHERE (KartID = @Original_KartID) AND (Ad = @Original_Ad) AND (Adres = @Original_Adres) AND (CepTel = @Original_CepTel) AND (Dahili = @Original_Dahili) AND (Departman = @Original_Departman) AND (Fax = @Original_Fax) AND (FirmaMail = @Original_FirmaMail) AND (Isim = @Original_Isim) AND (KisiMail = @Original_KisiMail) AND (Lvel = @Original_Lvel) AND (Saat = @Original_Saat OR @Original_Saat IS NULL AND Saat IS NULL) AND (Sehir = @Original_Sehir) AND (Sektor = @Original_Sektor) AND (Semt = @Original_Semt) AND (Sil = @Original_Sil) AND (Soyad = @Original_Soyad) AND (Tarih = @Original_Tarih OR @Original_Tarih IS NULL AND Tarih IS NULL) AND (Tel1 = @Original_Tel1) AND (Tel2 = @Original_Tel2) AND (Unvan = @Original_Unvan) AND (Vergi = @Original_Vergi) AND (VergiNo = @Original_VergiNo) AND (Web = @Original_Web); SELECT KartID, Isim, Tel1, Tel2, Fax, Semt, Adres, Sehir, Vergi, VergiNo, Web, FirmaMail, Sektor, Departman, Lvel, Ad, Soyad, Unvan, Dahili, CepTel, KisiMail, Sil, Tarih, Saat FROM tbl_mk WHERE (KartID = @KartID)";
		...
		private void btnKaydet_Click(object sender, System.EventArgs e)
		{
			...
			if (txtFIsim.Text.Trim()=="")
			{
				MessageBox.Show(this,"Boþ kayýt giremezsiniz.","DÝKKAT");
				hata=1;
			}	
			...
			if (hata==0)
			{
				ekle["Isim"]=txtFIsim.Text.Trim();
				ekle["Tel1"]=txtTel1.Text.Trim();
				ekle["Tel2"]=txtTel2.Text.Trim();
				ekle["Fax"]=txtFax.Text.Trim();
				ekle["Semt"]=txtSemt.Text.Trim();
				ekle["Sehir"]=cbSehir.Text.Trim();
				ekle["Adres"]=txtAdres.Text.Trim();
				ekle["Vergi"]=txtVerDai.Text.Trim();
				ekle["VergiNo"]=txtVerNo.Text.Trim();
				ekle["Web"]=txtWeb.Text.Trim();
				ekle["FirmaMail"]=txtFMail.Text.Trim();
				ekle["Sektor"]=cbSektor.Text.Trim();
				ekle["Departman"]=txtDep.Text.Trim();
				ekle["Ad"]=txtAd.Text.Trim();
				ekle["Soyad"]=txtSoyad.Text.Trim();
				ekle["Unvan"]=txtUnvan.Text.Trim();
				ekle["Dahili"]=txtDahili.Text.Trim();
				ekle["CepTel"]=txtCepTel.Text.Trim();
				ekle["KisiMail"]=txtKMail.Text.Trim();
				ekle["Tarih"]=DateTime.Now.ToShortDateString();
				ekle["Saat"]=DateTime.Now.ToShortTimeString();
				ekle["Sil"]=1;
				...
				MessageBox.Show(this,"Kayýt iþleminiz baþarý ile tamamlanmýþtýr.","Dikkat");
		...
		{
			MessageBox.Show("Zaten yeni kart sayfasýndasýnýz.","Hata Yaptýnýz");
		...
		private void KartlarYeni_Closed(object sender, System.EventArgs e)
		{
			Application.Exit();
		}
