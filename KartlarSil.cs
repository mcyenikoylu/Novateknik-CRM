...
namespace deneme
{
	...
	/// </summary>
	public class KartlarSil : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.DataGrid dg_KartlarSil;
		private System.Windows.Forms.Button btn_SilKartSil;
		...
		private System.Windows.Forms.DataGridTextBoxColumn isim;
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(KartlarSil));
			...
			this.dg_KartlarSil = new System.Windows.Forms.DataGrid();
			...
			this.isim = new System.Windows.Forms.DataGridTextBoxColumn();
			...
			this.btn_SilKartSil = new System.Windows.Forms.Button();
			...
			((System.ComponentModel.ISupportInitialize)(this.dg_KartlarSil)).BeginInit();
			...
			// dg_KartlarSil
			// 
			this.dg_KartlarSil.DataMember = "tbl_mk";
			this.dg_KartlarSil.DataSource = this.ds_musteri1;
			this.dg_KartlarSil.HeaderForeColor = System.Drawing.SystemColors.ControlText;
			this.dg_KartlarSil.Location = new System.Drawing.Point(168, 272);
			this.dg_KartlarSil.Name = "dg_KartlarSil";
			this.dg_KartlarSil.ReadOnly = true;
			this.dg_KartlarSil.Size = new System.Drawing.Size(808, 384);
			this.dg_KartlarSil.TabIndex = 49;
			this.dg_KartlarSil.TableStyles.AddRange(new System.Windows.Forms.DataGridTableStyle[] {
																									  this.dataGridTableStyle1});
			this.dg_KartlarSil.MouseDown += new System.Windows.Forms.MouseEventHandler(this.myDataGrid_MouseDown);
			// 
			// ds_musteri1
			// 
			...
			this.dataGridTableStyle1.DataGrid = this.dg_KartlarSil;
			...
			// 
			this.isim.Format = "";
			this.isim.FormatInfo = null;
			this.isim.HeaderText = "Firma Ýsmi";
			this.isim.MappingName = "Isim";
			this.isim.Width = 150;
			// 
			// tel1
			// 
			...
			this.ceptel.HeaderText = "Cep Telefonu";
			...
			// btn_SilKartSil
			// 
			this.btn_SilKartSil.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(162)));
			this.btn_SilKartSil.Location = new System.Drawing.Point(880, 664);
			this.btn_SilKartSil.Name = "btn_SilKartSil";
			this.btn_SilKartSil.Size = new System.Drawing.Size(75, 30);
			this.btn_SilKartSil.TabIndex = 50;
			this.btn_SilKartSil.Text = "Kart Sil";
			this.btn_SilKartSil.Click += new System.EventHandler(this.btn_SilKartSil_Click);
			// 
			// gb_Ara
			// 
			...
			this.Controls.Add(this.btn_SilKartSil);
			this.Controls.Add(this.dg_KartlarSil);
			...
			this.Name = "KartlarSil";
			this.Text = "Novateknik CRM";
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.KartlarSil_Load);
			this.Closed += new System.EventHandler(this.KartlarSil_Closed);
			this.pnlKartlar.ResumeLayout(false);
			this.pnlList.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.dg_KartlarSil)).EndInit();
		...
		{
			MessageBox.Show("Zaten kart silme sayfasýndasýnýz.","Hata Yaptýnýz");
		...
		private void myDataGrid_MouseDown(object sender, System.Windows.Forms.MouseEventArgs e)
		{
			...
			if(hti.Row>-1)
			{
				d_sil =dg_KartlarSil[hti.Row,0].ToString();
			
				Console.WriteLine(message);
			}
		}
		private void btn_SilKartSil_Click(object sender, System.EventArgs e)
		{
			...
			dugmesec =MessageBox.Show(this,"Bu kartý Silmek istediðinizden eminmisiniz?","DÝKKAT",MessageBoxButtons.YesNo,MessageBoxIcon.Warning,MessageBoxDefaultButton.Button2);
			if(dugmesec==DialogResult.Yes)

			{
			komut.CommandText ="UPDATE tbl_mk SET Sil ='0' where KartID ='" + KartlarSil.d_sil + "'";
			MessageBox.Show(this,"Kart baþarý ile silinmiþtir.","DÝKKAT");
			...
			dg_KartlarSil.DataSource=al.Tables[0];
		...
		private void KartlarSil_Load(object sender, System.EventArgs e)
		{
			if(Giris.yetki=="1")
			{
		...
		private void KartlarSil_Closed(object sender, System.EventArgs e)
		{
			Application.Exit();
		}
